...
public class UserController {
    ...
    public ResponseEntity<GeneralResponse> create(
        ...
        if (userService.findByEmail(request.getEmail()) != null) {
            ...
            return new ResponseEntity<>(new GeneralResponse(ResponseStatusEnum.ERROR, UserControllerMessage.EMAIL_OCCUPIED.toString()), HttpStatus.INTERNAL_SERVER_ERROR);
        }
        ...
        return new ResponseEntity<>(new GeneralResponse(ResponseStatusEnum.SUCCESS, UserControllerMessage.USER_CREATED.toString(), new SuccessAuthenticatedResponse(user.getId())), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<GeneralResponse> authenticate(
        ...
        if (user != null) {
            return new ResponseEntity<>(new GeneralResponse(ResponseStatusEnum.SUCCESS, UserControllerMessage.USER_AUTHENTICATED.toString(), new SuccessAuthenticatedResponse(user.getId())), HttpStatus.OK);
        } else {
            LOG.error("Failed authentication attempt for email {}", email);
            return new ResponseEntity<>(new GeneralResponse(ResponseStatusEnum.ERROR, UserControllerMessage.USER_INVALID_CREDENTIALS.toString()), HttpStatus.UNAUTHORIZED);
        }
    }
    ...
    public ResponseEntity<Object> get(
        ...
        if (user != null) {
            ...
            return new ResponseEntity<>(new GeneralResponse(ResponseStatusEnum.ERROR, UserControllerMessage.USER_NOT_FOUND.toString()), HttpStatus.NOT_FOUND);
        }
    }
